...
interface ParticleImageProps {
  ...
  particleSize?: number;
  particleShape?: "circle" | "square" | "both";
  particleColor?: "original" | "single" | "multi";
  singleColor?: string;
  multiColors?: string[];
  hoverEnabled?: boolean;
  hoverType?: "roam" | "hide" | "scatter";
  hideType?: "scatter" | "in-place";
  roamWidth?: number;
  roamHeight?: number;
  roamOpacity?: number;
  roamShape?: "rectangle" | "circle" | "oval";
...
export default function ParticleImage({
  ...
  const transition = { duration: transitionDuration, ease: transitionEase };
  ...
  useEffect(() => {
    initParticles();
  }, [src, particleCount, hoverEnabled, hoverType, roamWidth, roamHeight, roamShape, hideType]);
